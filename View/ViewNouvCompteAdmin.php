...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/nouCompteEtu.css" >
    ...
    <header class="header">
        ...
        <div class="cercle">
            ...
            <div class="perso">
                ...
                <img src="../assets/img/perso.png" class="perso" alt="Perso en haut du rectangle principale">
        ...
        <div class="princi-rectangle">
            ...
            <form action="../Controller/ControllerCreation.php" method="post">
                ...
                <div class="cv-rectangle">
                    ...
                    <input type="file" name="cv" class="input-cv">
                </div>
        ...
        <a href="ViewConnexionAdmin.php" class="lien"><p class="lien-info">Connexion</p></a>
